...
public interface adminDao {
     ...
     * @return
     */
    @Update("update admin set adminPassword=#{adminPassword} where adminAccount=#{adminAccount}")
    public int updateAdminPassword(@Param("adminAccount") String adminAccount,@Param("adminPassword") String adminPassword);

...
public class recharge_recordService
{
     ...
     * @return
     */
    public List<recharge_record> currentDayIncome(String date){
        return recharge_recorddao.currentDayIncome(date);
    }
    ...
    public paging<Map<String,Object>> rechargeStatistics(Integer page, Integer rows, String customName){
        Integer total=recharge_recorddao.rechargeStatistics(customName).size();
        PageHelper.startPage(page,rows);
        List<Map<String,Object>> mapList=recharge_recorddao.rechargeStatistics(customName);
